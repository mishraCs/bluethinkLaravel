...
<div class=" header_nav form_div">
    ...
    <form for="form_element" class="form-group" method="post" action="{{ route('register') }}" name="myForm"  enctype="multipart/form-data">
       ...
       <div id = "name" ><label>First Name:</label><br><span class="form_error"></span>
            <input class="form-control" type="text" id="first_name" name="first_name" value="{{Auth::user()->first_name}}"  required ><br>
            @error('first_name') 
        ...
        <input class="form-control" type="text" id="last_name" name="last_name" value="{{Auth::user()->last_name}}" required ><br>
        @error('last_name') 
        <div class='error'>{{ $message }}</div>
        @enderror
        </div>
        ...
        <input class="form-control" type="email" id="email" name="email" value="{{Auth::user()->email}}" required ><br>
        @error('email') 
        <div class='error'>{{ $message }}</div>
        @enderror
        </div>
        ...
        <div>
            <img src="{{Auth::user()->profile_image}}" alt="add a profile_image">
        </div>
